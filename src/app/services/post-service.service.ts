...
import { Post } from '../models/ghof/post';
import { FileDB } from '../models/ghof/fileDB';
...
export class PostServiceService {
  ...
  getPostsurl="http://localhost:8181/post/getAllpost";
  getPostbyIdsurl="http://localhost:8181/post/getpost";
  addPostUrl="http://localhost:8181/post/addPost";
  modifierPostUrl="http://localhost:8181/post/updatepost";
  deletePostUrl="http://localhost:8181/post/deletepost";
  uploadfilef="http://localhost:8181/File/uploadf";
  getfiledetail="http://localhost:8181/File/filesdetail";
  getfiledeposturl="http://localhost:8181/File/filesdearticle";
  deletefiles="http://localhost:8181/File/delete-file";
  /////////////////////////////////////////////////
  addlikeurl="http://localhost:8181/post/addLike";
  adddislikeurl="http://localhost:8181/post/addDislike";
  nbrlikeurl="http://localhost:8181/post/nbrLike";;
  nbrdislikeurl="http://localhost:8181/post/nbrDisLike";
  ///////////////////////////////////////////////////
  addcommentaireurl="http://localhost:8181/api/comment/addcmt";
  getcmtbypostsurl="http://localhost:8181/api/comment/getallcmtbypost";
  ...
  affecterfileaupost(id:Number,idf:Number,article :Post):Observable<Post>{
    return this.http.put<Post>("http://localhost:8181/File/affecter-fileToArticle/"+id+"/"+idf,article);
  }
